...
<body>
    <div id="wrapper">
        ...
        <hr style="border:0; border-top: 1px solid #30363d; margin: 20px 0;">
        <footer><a href="dashboard.php">&larr; Voltar ao Dashboard</a><a href="consultaTalentos.php">&larr; Ver Talentos</a><a href="../controller/logout.php" style="color: #ff7b72; margin-left:20px;">&larr; Sair</a>
