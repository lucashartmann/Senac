                ...
                <div class="container">
                    ...
                    <?php else: ?>
                        <form onsubmit="return false;" style="margin-bottom:25px;">
                            <input type="text" id="pesquisa" name="pesquisa" placeholder="Digite o filtro" style="width: 100%; margin-bottom:0;">
                        </form>
                            ...
                            <tbody id="corpo-tabela">
                                <?php foreach ($talentos as $t): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <span style="background-color: #21262d; padding: 4px 8px; border-radius: 4px; font-size: 0.85rem; border: 1px solid #30363d;">
