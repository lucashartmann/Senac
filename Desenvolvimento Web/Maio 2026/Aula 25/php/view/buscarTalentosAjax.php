...
if (empty($talentos)) {
    ...
    foreach ($talentos as $talento) {
        $nome = mb_convert_encoding($talento['nome'], 'UTF-8', 'auto');
        $tecnologia = mb_convert_encoding($talento['tecnologia'], 'UTF-8', 'auto');
        echo "<tr>";
        ...
        echo "<td> <span>"
            ...
            . "</span></td>";
        echo "<td>  
            <a href='edicao.php?id=" . $talento['idTalento'] . "' class=\"btn-acao btn-editar\">Editar</a>
            <a href=\"../controller/controller.php?acao=excluir&id=" . $talento['idTalento'] . "\" class=\"btn-acao btn-excluir\" onclick=\"return confirm('Tem certeza que deseja excluir este talento?')\">Excluir</a>
            </td>";
        echo "</tr>";
    }
}
