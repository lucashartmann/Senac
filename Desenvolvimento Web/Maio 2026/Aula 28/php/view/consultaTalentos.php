...
<body>
    <div id="wrapper" class="dashboard-container">
        <div class="container">
            ...
            <hr>
            <div class="post">
                <h2 style="margin-bottom: 20px;">Consulta de Talentos Cadastrados</h2>
                ...
                <div class="container">
                    ...
                    <?php else: ?>
                        <form onsubmit="return false;" style="margin-bottom:25px;">
                            <input type="text" id="pesquisa" name="pesquisa" placeholder="Digite o filtro" style="width: 100%; margin-bottom:0; margin-top:10px;">
                        </form>
                        <table border="1" style="width: 100%; border-collapse: collapse;">
                            ...
                            <tbody id="corpo-tabela">
                                <?php foreach ($talentos as $t): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($t->getNome()); ?></td>
                                        <td><?php echo htmlspecialchars($t->getEmail()); ?></td>
                                        <td><?php echo htmlspecialchars($t->getFone()); ?></td>
                                        <td>
                                            <span>
                                                <?php echo htmlspecialchars(mb_convert_encoding($t->getTecnologia(), 'UTF-8', 'auto')); ?>
                                            </span>
                                        </td>
                                        <td style="text-align:center;">
                                            <a href="edicao.php?id=<?php echo $t->getId(); ?>" class="btn-acao btn-editar">Editar</a>
                                            <a href="../controller/controller.php?acao=excluir&id=<?php echo $t->getId(); ?>" class="btn-acao btn-excluir" onclick="return confirm('Tem certeza que deseja excluir este talento?')">Excluir</a>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                            </tbody>
