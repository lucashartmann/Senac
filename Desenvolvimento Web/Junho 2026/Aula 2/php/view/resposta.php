    ...
    <div id="wrapper">
        <div class="container">
            ...
            <div class="post">
                ...
                <p>Olá, <strong> <?php echo $usuario instanceof Talento ? $usuario->getNome() : $usuario->getLogin(); ?>!</strong>. Seu acesso foi validado com sucesso <span style="color: #58a6ff; font-weight:bold;"><?php echo $usuario instanceof Talento ? 'Talento' : strtoupper($usuario->getPerfil() ?? ''); ?></span></p>
