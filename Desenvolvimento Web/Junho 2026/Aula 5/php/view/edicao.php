        ...
        <div class="container">
            <div class="post">
                ...
                <form action="../controller/controller.php?acao=cadastrar" method="POST">
                    <input type="hidden" name="id" value="<?= $talento->getId() ?>">
                    <div class="form-group">
                        <label for="nome">Nome:</label>
                        <input type="text" name="nome" id="nome" value="<?= htmlspecialchars($talento->getNome()) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="email">Email:</label>
                        <input type="email" name="email" id="email" value="<?= htmlspecialchars($talento->getEmail()) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="fone">Telefone:</label>
                        <input type="text" name="fone" id="fone" value="<?= htmlspecialchars($talento->getFone()) ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="tecnologia">Tecnologias:</label>
                        <input type="text" name="tecnologia" id="tecnologia" value="<?= htmlspecialchars($talento->getTecnologia()) ?>" required>
                    </div>
