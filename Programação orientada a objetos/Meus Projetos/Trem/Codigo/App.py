...
import controller.ControllerCMD as ControllerCMD
import sys
...
if len(comando) > 1:
    ...
    # COMANDOS ######:
    # python App.py ajuda
    # python App.py adicionar_vagao 100.0
    # python App.py adicionar_locomotiva 100.0 500.0
    # python App.py adicionar_trem
    # python App.py remover 1
    # python App.py engatar 1 2
    # python App.py desengatar 1 2
    # python App.py esvaziar_garagem_locomotiva
    # python App.py esvaziar_garagem_vagao
    # python App.py esvaziar_garagem_trem
    # python App.py esvaziar_trem 1
    # python App.py listar_trens
    # python App.py listar_locomotivas
    # python App.py listar_vagoes
    # python App.py listar_veiculos
